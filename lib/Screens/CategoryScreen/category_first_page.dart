...
class CategoryFirstPage extends StatefulWidget {
  const CategoryFirstPage({Key? key}) : super(key: key);
  static const String id = 'CategoryFirstPage';

  @override
  State<CategoryFirstPage> createState() => _CategoryFirstPageState();
}

class _CategoryFirstPageState extends State<CategoryFirstPage> {
